...
import com.briswell.mycalendar.CalendarUtils.TimeZoneUtils;
...
public class Utils {
    ...
    **/
    ...
    public static String getWidgetUpdateAction(Context context) {
        return "com.briswell.mycalendar.APPWIDGET_UPDATE";
    }
    ...
    public static String getWidgetScheduledUpdateAction(Context context) {
        return "com.briswell.mycalendar.APPWIDGET_SCHEDULED_UPDATE";
    }
    ...
    public static String getSearchAuthority(Context context) {
        return "com.briswell.mycalendar.CalendarRecentSuggestionsProvider";
    }
