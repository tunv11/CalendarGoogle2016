...
package com.briswell.mycalendar.agenda;
...
import com.briswell.mycalendar.CalendarController;
import com.briswell.mycalendar.EventInfoFragment;
import com.briswell.mycalendar.GeneralPreferences;
import com.briswell.mycalendar.R;
import com.briswell.mycalendar.StickyHeaderListView;
import com.briswell.mycalendar.Utils;

import java.util.Date;

import static com.briswell.mycalendar.CalendarController.EXTRA_GOTO_TODAY;
import static com.briswell.mycalendar.CalendarController.EventHandler;
import static com.briswell.mycalendar.CalendarController.EventInfo;
import static com.briswell.mycalendar.CalendarController.EventType;
import static com.briswell.mycalendar.CalendarController.ViewType;
import static com.briswell.mycalendar.CalendarController.getInstance;

public class AgendaFragment extends Fragment implements EventHandler,
        OnScrollListener {
    ...
    public void onCreate(Bundle icicle) {
        ...
        mController = getInstance(mActivity);
...
//        Utils.setDefaultView(this, CalendarApplication.AGENDA_VIEW_ID);
    ...
    private void goTo(EventInfo event, boolean animate) {
        ...
        mAgendaListView.goTo(mTime, event.id, mQuery, false,
                ((event.extraLong & EXTRA_GOTO_TODAY) != 0 &&
